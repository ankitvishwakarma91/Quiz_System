...
Password:     <input type="text" name="pass">
             ...
             <input type="submit" value="Register" class="btn btn-outline-primary">   <input type="button"
                                                                                             onclick="location.href='AdminPanel.jsp'"
                                                                                             value="Home"
                                                                                             class="btn btn-outline-success">    <input
        type="button" onclick="location.href='StudentList.jsp'" value="Back" class="btn btn-outline-danger">
</pre>
</form>
<div>
    <font color="red">
    ...
    <font color="red">
        <%
            if (request.getParameter("msg3") != null)
                out.print(request.getParameter("msg3"));
        %>
    </font>
    <font color="green">
        <%
            if (request.getParameter("msg4") != null)
                out.print(request.getParameter("msg4"));
        %>
    </font>
</div>
