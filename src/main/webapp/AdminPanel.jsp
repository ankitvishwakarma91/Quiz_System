  ...
  <pre>
   ...
   <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-6"><center><input onclick="location.href='com.controller.LogoutAdmin'" type="button" value="Logout" class="btn btn-outline-primary btn-lg btn-block"></center></div>
    </div>  
  </div>
  </center>
</body>
